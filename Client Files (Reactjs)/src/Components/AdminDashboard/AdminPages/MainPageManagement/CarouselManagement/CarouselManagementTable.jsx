...
import $ from "jquery";
import "./CarouselManagementTable.css";
import { ApiName } from "../../../../ApiName";
class CarouselsManagementTable extends React.Component {
  componentDidMount() {
              ...
              <tr>
                <td>
                  <div className="col-md-4">
                    <img
                      src={ApiName + "/images/carousel/" + data.imageLocation}
                      alt=""
                      className="img-fluid"
                    />
                  </div>
...
export default CarouselsManagementTable;
