...
import $ from "jquery";
import "./WritersManagementTable.css";
class WritersManagementTable extends React.Component {
  componentDidMount() {
    $("#articletable").DataTable({
      ...
      language: {
        emptyTable: "هیچ نویسنده ای موجود نیست",
        infoEmpty: "",
      },
      oLanguage: {
        sSearch: "جستجو",
...
export default WritersManagementTable;
